	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('b pa1 ma0'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pa1 w-100 ma0'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Main$tastyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
			...
			default:
				return {
					...
					_1: A2(
						...
						A2(_elm_lang$core$Maybe$withDefault, '', model.server_address),
						model.message_text)
				};
		}
	});
var _user$project$Main$initial_model = {
	server_address: _elm_lang$core$Maybe$Nothing,
	message_text: '',
	username: _elm_lang$core$Maybe$Nothing,
	messages: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'user', _1: 'message'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'user', _1: 'message'},
			_1: {ctor: '[]'}
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {server_address: a, message_text: b, username: c, messages: d};
	});
var _user$project$Main$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _user$project$Main$ReceivedMessage = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$websocket$WebSocket$listen,
		A2(_elm_lang$core$Maybe$withDefault, '', model.server_address),
		_user$project$Main$ReceivedMessage);
};
var _user$project$Main$SendMsg = {ctor: 'SendMsg'};
var _user$project$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mt3 mw6 container center flex flex-column'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('f2 code lh-copy'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('WebSocket Client'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('code i mt0 tracked'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('ba mb3 flex h5 flex-column'),
							_1: {ctor: '[]'}
						},
						A2(_elm_lang$core$List$map, _user$project$Main$msgView, model.messages)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('flex flex-row justify-start'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('input-reset ba b--black mr1 pa1 w-100'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewMessage),
											_1: {
												ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('button-reset ba b--black pa1 ph3'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SendMsg),
												_1: {ctor: '[]'}
											}
										},
										{
